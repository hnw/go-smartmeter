...
func main() {
	...
	request := smartmeter.NewFrame(smartmeter.NodeProfile, smartmeter.Get, []*smartmeter.Property{
		smartmeter.NewProperty(smartmeter.NodeProfileVersionInformation, nil),
		smartmeter.NewProperty(smartmeter.NodeProfileManufacturerCode, nil),
		smartmeter.NewProperty(smartmeter.NodeProfileSelfNodeInstanceListS, nil),
	})
